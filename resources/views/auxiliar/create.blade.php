...
@section('contenido')
    ...
    <section class="content">
        <div class="container-fluid">                  
            <form action="{{route('auxiliar.store')}}" class="form-horizontal" id="form-general" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <div class="card card-danger">
                    ...
                    <div class="card-body"> 
                        ...
                        @include('includes.formularios.form-datosIdentificacion') 
                    </div>
                </div>
