...
<section class="content">
    <div class="container-fluid">     
        <form action="{{route('historiaB.update', ['id'=>$identificacion->id, 'idh'=>$eventos->id])}}" id="form-general" method="POST" autocomplete="off" enctype="multipart/form-data">  
            @csrf @method("put")
            ...
            <div class="card card-success">
                ...
                <div class="card-body">
                    <textarea id="editor1" name="formatoBlanco" rows="10" cols="80" tabindex="1">
                        {{old('fechaConsulta', $eventos->historiaBlanco->formatoBlanco ?? '')}}
                    </textarea>
                </div>
            </div>
            <!-- Inicio Historia Blanco-->
