    ...
    <div class="col-md-12 row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select name="tipoVinculacion" id="tipoVinculacion" class="form-control" tabindex="5">
            ...
            <div class="form-group">
                ...
                <input type="text" name="responsableMedico" class="form-control" id="responsableMedico" value="{{old('responsableMedico', $data->afiliacion->responsableMedico ?? '')}}" tabindex="5">
            </div>
            <div class="form-group">
                <label for="telefonoResponsable">Telefono de Responsable</label>
                <input type="text" name="telefonoResponsable" class="form-control" id="telefonoResponsable" value="{{old('telefonoResponsable', $data->afiliacion->telefonoResponsable ?? '')}}" tabindex="5">
            </div>            
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="aseguradora" class="form-control" id="aseguradora" value="{{old('aseguradora', $data->afiliacion->aseguradora ?? '')}}" tabindex="5">
            </div>
            <div class="form-group">
                <label for="parentescoResponsable">Parentesco de Responsable</label>
                <input type="text" name="parentescoResponsable" class="form-control" id="parentescoResponsable" value="{{old('parentescoResponsable', $data->afiliacion->parentescoResponsable ?? '')}}" tabindex="5">
            </div>
